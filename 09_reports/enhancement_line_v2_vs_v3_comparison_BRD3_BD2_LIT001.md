...
- frozen baseline case: `BRD3_BD2_LIT001`
- enhancement experiment case: `BRD3_BD2_LIT001_V3EXP`
...
- baseline `BRD3_BD2_LIT001`
  - `filter_keep_count = 1`
  - `shortlist_count = 1`
  - shortlist: `JQ1`
- enhancement `BRD3_BD2_LIT001_V3EXP`
  - `filter_keep_count = 1`
  - `shortlist_count = 1`
  - shortlist: `JQ1`
...
| Dimension | `BRD3_BD2_LIT001` | `BRD3_BD2_LIT001_V3EXP` |
| --- | --- | --- |
| Rerank model | `cpu_docking_rerank_v2` | `cpu_docking_rerank_v3` |
| Top 1 | `JQ1` | `JQ1` |
| Top 1 rerank score | `-6.705` | `-7.9` |
| Top 2 | `BG_BIPHENYL` | `BG_ASPIRIN` |
| Top 2 rerank score | `-6.49` | `-5.641` |
| Top 3 | `BG_BENZAMIDE` | `BG_ETHYL_PARABEN` |
| Top 3 rerank score | `-6.375` | `-5.461` |
| Filter keep count | `1` | `1` |
| Shortlist count | `1` | `1` |
| Shortlist ids | `JQ1` | `JQ1` |
| Known active id | `JQ1` | `JQ1` |
| Best background id | `BG_BIPHENYL` | `BG_ASPIRIN` |
| Active-best-background gap | `0.215` | `2.259` |
...
- Baseline best background: `BG_BIPHENYL` with gap `0.215`
- Enhancement best background: `BG_ASPIRIN` with gap `2.259`
- Enhancement known active shortlisted: `True`

## Prioritization Interpretation

The enhancement-line prioritization policy for `BRD3_BD2_LIT001_V3EXP` was:
...
- Latest phase timings: `read = 0.008341` | `scoring = 0.042898` | `output = 0.005373`
- Latest cache-hit cases: `none observed in current summary`

### `clustering_and_prioritization`

- Latest phase timings: `read = 0.013895` | `scoring = 0.000761` | `output = 0.001847`
- Latest cache-hit cases: `none observed in current summary`
