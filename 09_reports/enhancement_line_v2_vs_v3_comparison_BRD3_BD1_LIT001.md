...
- frozen baseline case: `BRD3_BD1_LIT001`
- enhancement experiment case: `BRD3_BD1_LIT001_V3EXP`
...
- baseline `BRD3_BD1_LIT001`
  - `filter_keep_count = 1`
  - `shortlist_count = 1`
  - shortlist: `JQ1`
- enhancement `BRD3_BD1_LIT001_V3EXP`
  - `filter_keep_count = 1`
  - `shortlist_count = 1`
  - shortlist: `JQ1`
...
- Baseline best background: `BG_BIPHENYL` with gap `0.12`
- Enhancement best background: `BG_ASPIRIN` with gap `1.759`
- Enhancement known active shortlisted: `True`

## Prioritization Interpretation

The enhancement-line prioritization policy for `BRD3_BD1_LIT001_V3EXP` was:
...
- Latest phase timings: `read = 0.008631` | `scoring = 0.053801` | `output = 0.005126`
- Latest cache-hit cases: `none observed in current summary`

### `clustering_and_prioritization`

- Latest phase timings: `read = 0.009951` | `scoring = 0.00078` | `output = 0.001663`
- Latest cache-hit cases: `none observed in current summary`
