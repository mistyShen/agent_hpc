...
- frozen baseline case: `BRD4_BD1_LIT001`
- enhancement experiment case: `BRD4_BD1_LIT001_V3EXP`
...
- baseline `BRD4_BD1_LIT001`
  - `filter_keep_count = 1`
  - `shortlist_count = 1`
  - shortlist: `JQ1`
- enhancement `BRD4_BD1_LIT001_V3EXP`
  - `filter_keep_count = 1`
  - `shortlist_count = 1`
  - shortlist: `JQ1`
...
| Dimension | `BRD4_BD1_LIT001` | `BRD4_BD1_LIT001_V3EXP` |
| --- | --- | --- |
| Rerank model | `cpu_docking_rerank_v2` | `cpu_docking_rerank_v3` |
| Top 1 | `JQ1` | `JQ1` |
| Top 1 rerank score | `-6.23` | `-7.4` |
| Top 2 | `BG_ANILINE` | `BG_ASPIRIN` |
| Top 2 rerank score | `-2.43` | `-5.541` |
| Top 3 | `BG_PHENOL` | `BG_PARACETAMOL` |
| Top 3 rerank score | `-2.275` | `-5.121` |
| Filter keep count | `1` | `1` |
| Shortlist count | `1` | `1` |
| Shortlist ids | `JQ1` | `JQ1` |
| Known active id | `JQ1` | `JQ1` |
| Best background id | `BG_ANILINE` | `BG_ASPIRIN` |
| Active-best-background gap | `3.8` | `1.859` |
...
- `BG_PARACETAMOL`
  - `docking_core = -5.5`
  - `artifact_penalty = 0.0`
  - `physchem_penalty = 0.379`
  - `physchem_snapshot = {"aromatic_atom_count": 0, "aromatic_fraction": 0.0, "hetero_atom_count": 3, "molecular_weight_estimate": 142.093, "ring_index_count": 1}`

Mean top-window `v3` penalties:

- `artifact_penalty = 0.0`
- `physchem_penalty = 0.287`
...
- Baseline best background: `BG_ANILINE` with gap `3.8`
- Enhancement best background: `BG_ASPIRIN` with gap `1.859`
- Enhancement known active shortlisted: `True`

## Prioritization Interpretation

The enhancement-line prioritization policy for `BRD4_BD1_LIT001_V3EXP` was:
...
- Latest phase timings: `read = 0.007055` | `scoring = 0.030849` | `output = 0.002744`
- Latest cache-hit cases: `none observed in current summary`

### `clustering_and_prioritization`

- Latest phase timings: `read = 0.005679` | `scoring = 0.000687` | `output = 0.005719`
- Latest cache-hit cases: `none observed in current summary`
