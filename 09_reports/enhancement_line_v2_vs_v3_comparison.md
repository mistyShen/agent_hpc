...
- frozen baseline case: `BRD4_BD1_LIT002`
...
- baseline `BRD4_BD1_LIT002`
  - `filter_keep_count = 2`
  - `shortlist_count = 2`
  - shortlist: `I-BET762, BG_BIPHENYL`
- enhancement `BRD4_BD1_LIT002_V3EXP`
  - `filter_keep_count = 2`
  - `shortlist_count = 1`
  - shortlist: `I-BET762`
...
| Dimension | `BRD4_BD1_LIT002` | `BRD4_BD1_LIT002_V3EXP` |
| --- | --- | --- |
| Rerank model | `cpu_docking_rerank_v2` | `cpu_docking_rerank_v3` |
| Top 1 | `I-BET762` | `I-BET762` |
| Top 1 rerank score | `-7.68` | `-8.9` |
| Top 2 | `BG_BIPHENYL` | `BG_BIPHENYL` |
| Top 2 rerank score | `-6.87` | `-2.754` |
| Top 3 | `BG_BENZAMIDE` | `BG_BENZAMIDE` |
| Top 3 rerank score | `-6.47` | `-2.741` |
| Filter keep count | `2` | `2` |
| Shortlist count | `2` | `1` |
| Shortlist ids | `I-BET762, BG_BIPHENYL` | `I-BET762` |
| Known active id | `I-BET762` | `I-BET762` |
| Best background id | `BG_BIPHENYL` | `BG_BIPHENYL` |
| Active-best-background gap | `0.81` | `6.146` |
...
- Baseline best background: `BG_BIPHENYL` with gap `0.81`
- Enhancement best background: `BG_BIPHENYL` with gap `6.146`
- Enhancement known active shortlisted: `True`

## Prioritization Interpretation

The enhancement-line prioritization policy for `BRD4_BD1_LIT002_V3EXP` was:

- `filter_keep_then_v3_rerank_margin_then_vina_v2`

Observed values:

- `filter_keep_input_count = 2`
- `shortlist_count = 1`
- `shortlist_cap = 1`
- `top_score_gap = 6.146`
...
- Latest cache-hit cases: `BRD4_BD1_LIT002, BRD4_BD1_LIT002_V3EXP`

### `clustering_and_prioritization`

- Latest phase timings: `read = 0.005679` | `scoring = 0.000687` | `output = 0.005719`
- Latest cache-hit cases: `BRD4_BD1_LIT002_V3EXP`
