...
- frozen baseline case: `BRDT_BD1_LIT001`
- enhancement experiment case: `BRDT_BD1_LIT001_V3EXP`
...
- baseline `BRDT_BD1_LIT001`
  - `filter_keep_count = 2`
  - `shortlist_count = 2`
  - shortlist: `JQ1, BG_BIPHENYL`
- enhancement `BRDT_BD1_LIT001_V3EXP`
  - `filter_keep_count = 1`
  - `shortlist_count = 1`
  - shortlist: `JQ1`
...
| Dimension | `BRDT_BD1_LIT001` | `BRDT_BD1_LIT001_V3EXP` |
| --- | --- | --- |
| Rerank model | `cpu_docking_rerank_v2` | `cpu_docking_rerank_v3` |
| Top 1 | `JQ1` | `JQ1` |
| Top 1 rerank score | `-7.655` | `-8.9` |
| Top 2 | `BG_BIPHENYL` | `BG_ASPIRIN` |
| Top 2 rerank score | `-6.775` | `-5.941` |
| Top 3 | `BG_ASPIRIN` | `BG_PARACETAMOL` |
| Top 3 rerank score | `-6.385` | `-5.321` |
| Filter keep count | `2` | `1` |
| Shortlist count | `2` | `1` |
| Shortlist ids | `JQ1, BG_BIPHENYL` | `JQ1` |
| Known active id | `JQ1` | `JQ1` |
| Best background id | `BG_BIPHENYL` | `BG_ASPIRIN` |
| Active-best-background gap | `0.88` | `2.959` |
...
- Baseline best background: `BG_BIPHENYL` with gap `0.88`
- Enhancement best background: `BG_ASPIRIN` with gap `2.959`
- Enhancement known active shortlisted: `True`

## Prioritization Interpretation

The enhancement-line prioritization policy for `BRDT_BD1_LIT001_V3EXP` was:
...
- Latest phase timings: `read = 0.006866` | `scoring = 0.038248` | `output = 0.003493`
- Latest cache-hit cases: `none observed in current summary`

### `clustering_and_prioritization`

- Latest phase timings: `read = 0.006949` | `scoring = 0.00069` | `output = 0.002552`
- Latest cache-hit cases: `none observed in current summary`
