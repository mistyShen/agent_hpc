...
BACKEND_REGISTRY: tuple[BackendSpec, ...] = (
    ...
    _backend(
        ...
        ("pseudobulk_de_results.tsv", "pseudobulk_de_backend_status.tsv", "pseudobulk_de_backend_manifest.json"),
        "PBMC3k/NSCLC pseudobulk design-ready validation",
        ...
        skip_reason="Design-ready export exists; formal per-cluster DESeq2/edgeR runner is not yet wired.",
        resource_profile="medium_r",
    ...
    _backend(
        ...
        production_allowed=True,
        backend_status="planned_fully_automatic",
        skip_reason="Input-gated scVelo runner exists; public spliced/unspliced validation data failed to cache on the cluster network.",
