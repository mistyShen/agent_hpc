...
VALIDATION_RUN_REQUIREMENTS = {
    ...
    "slurm_proteomics_public": {
        "label_cn": "LFQ-Analyst MaxQuant 蛋白组公开 Slurm 验证",
        "run_dir": "validations/slurm_proteomics_lfq_analyst_public",
        "module": "proteomics",
        "min_tables": 8,
        "min_figures": 4,
        "min_objects": 1,
...
VALIDATION_RUN_COMMANDS = {
    ...
    "slurm_proteomics_public": {
        "slurm_script": "slurm/proteomics_backend_validation.sbatch",
        "recommended_entrypoint": "hpc-sbatch",
        "recommended_command": "hpc-sbatch {root}/slurm/proteomics_backend_validation.sbatch",
        "prerequisite_command": "",
        "module_or_scope": "proteomics",
        "compute_policy": "slurm_required_for_public_validation",
    },
    "scrna_mvp_h5ad": {
    ...
    "slurm_multiome": {
        "slurm_script": "slurm/multiome_backend_validation.sbatch",
        "recommended_entrypoint": "hpc-sbatch",
        "recommended_command": "hpc-sbatch {root}/slurm/multiome_backend_validation.sbatch",
        "prerequisite_command": "hpc-sbatch {root}/slurm/download_public_singlecell_data.sbatch",
    ...
    "slurm_spatial": {
        "slurm_script": "slurm/spatial_backend_validation.sbatch",
        "recommended_entrypoint": "hpc-sbatch",
        "recommended_command": "hpc-sbatch {root}/slurm/spatial_backend_validation.sbatch",
        "prerequisite_command": "hpc-sbatch {root}/slurm/download_public_singlecell_data.sbatch",
...
def _slurm_adapter_files_present(root: Path) -> bool:
    required = (
        ...
        root / "slurm" / "proteomics_backend_validation.sbatch",
